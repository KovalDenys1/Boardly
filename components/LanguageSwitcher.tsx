      ...
      <select
        ...
        className={
          isPanelVariant
            ...
            : 'w-full appearance-none rounded-xl border border-white/30 bg-white/20 px-3 py-2 pr-9 text-xs font-semibold text-white shadow-[0_10px_30px_rgba(37,99,235,0.18),inset_0_1px_0_rgba(255,255,255,0.22)] backdrop-blur-md outline-none transition hover:bg-white/30 focus:border-white/40 focus:bg-white/30 focus:ring-2 focus:ring-white/25 [color-scheme:dark]'
        }
