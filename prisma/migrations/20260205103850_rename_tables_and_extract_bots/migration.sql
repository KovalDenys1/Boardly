...
RENAME TO "EmailVerificationTokens";
...
ALTER TABLE "Bots"
ADD CONSTRAINT "Bots_userId_fkey" FOREIGN KEY ("userId") REFERENCES "Users" ("id") ON DELETE CASCADE ON UPDATE CASCADE;
...
SELECT id, id, 'yahtzee', -- All existing bots are Yahtzee bots
