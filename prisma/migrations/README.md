...
### Core Tables
- **Users** - User accounts (regular and guest with friend codes)
- **Bots** - AI players with skill levels
...
### Game Management
- **Lobbies** - Game lobbies with turn timers
- **Games** - Active games with type/status enums
- **Players** - Player data including yahtzee stats

### Social Features
- **FriendRequests** - Friend request system
- **Friendships** - Accepted friendships
- **SpyLocations** - Spy game location data
