                ...
                >
                  ...
                  <div className="rounded-[24px] border border-slate-200 bg-slate-50/90 p-3 dark:border-slate-700 dark:bg-slate-800/70 md:grid md:grid-cols-[minmax(0,1fr)_170px] md:items-center md:gap-4">
                    ...
                    <Link
                      ...
                      className="mt-3 inline-flex border-t border-slate-200/80 pt-3 text-sm font-medium text-blue-600 hover:underline dark:border-slate-700/80 dark:text-blue-400 md:mt-0 md:justify-self-end md:border-t-0 md:pt-0"
                    >
