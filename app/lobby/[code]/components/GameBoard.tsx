...
export default function GameBoard({
  ...
  return (
    <div className="h-full flex flex-col gap-3">
      ...
      <div className="flex-1 bg-gradient-to-br from-white to-gray-50 dark:from-gray-800 dark:to-gray-900 rounded-2xl shadow-xl border border-gray-200 dark:border-gray-700 overflow-hidden flex flex-col">
      ...
      <div className="flex-shrink-0 space-y-2">
        {/* Turn Indicator */}
        {isMyTurn ? (
          <div className={`text-center px-3 py-2 rounded-xl shadow-lg transition-all duration-300 ${
            timeLeft <= 10
              ? 'bg-gradient-to-r from-red-500 to-pink-500 text-white animate-pulse'
              : 'bg-gradient-to-r from-green-500 to-emerald-500 text-white'
          }`}>
            <div className="flex items-center justify-center gap-2">
              <span className="text-xl">{timeLeft <= 10 ? '⚠️' : '🎯'}</span>
