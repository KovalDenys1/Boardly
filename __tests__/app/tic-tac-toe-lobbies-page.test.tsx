...
describe('Tic-Tac-Toe lobby list page', () => {
  ...
  it('loads tic-tac-toe lobbies, refreshes on Supabase Realtime updates, and cleans up on unmount', async () => {
    ...
    expect(mockSupabaseClient.channel).toHaveBeenCalledWith('game-lobbies-tic_tac_toe')
