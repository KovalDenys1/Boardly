const no = {
  ...
  games: {
    ...
    checkers: {
      name: 'Dam',
      description: 'Hopp, slå og kron kongene dine i det klassiske damspillet.',
      difficulty: 'Middels',
      seo: {
      ...
      detail: {
        ...
        step4Desc: 'Nå bakerste rad for å krone en konge. La motstanderen stå uten lovlig trekk for å vinne.',
        benefitsTitle: 'Hvorfor spille dam på Boardly?',
        benefit1: 'Flerspiller i sanntid i nettleseren.',
      ...
      lobbies: {
        title: 'Dam-lobbyer',
        subtitle: 'Bli med i et spill eller opprett din egen lobby!',
        subtitleGuest: 'Se lobbyer og logg inn når du vil være vert eller bli med.',
        backToGames: 'Tilbake til spill',
        wantToPlay: 'Vil du spille?',
        wantToPlayDesc: 'Logg inn eller opprett en konto for å være vert og bli med i spill.',
        signIn: 'Logg inn',
        createAccount: 'Opprett konto',
        createNewLobby: 'Opprett ny lobby',
        createDescription: 'Start et damparti og utfordre en venn!',
        createNow: 'Opprett nå',
        quickJoin: 'Hurtigtilgang',
        quickJoinDesc: 'Har du en lobbykode? Skriv den inn under for å bli med med en gang!',
        enterCode: 'Skriv inn 4-sifret kode',
        signInToJoin: 'Logg inn før du blir med i en lobby.',
        activeLobbies: 'Aktive lobbyer',
        noLobbiesTitle: 'Ingen aktive lobbyer akkurat nå. Bli den første som starter et spill!',
        createFirstLobby: 'Opprett første lobby',
        host: 'Vert',
        waiting: 'Venter',
        playing: 'Spiller',
      ...
      game: {
        lobbyNotFoundTitle: 'Fant ikke lobbyen',
        lobbyNotFoundDescription: 'Lobbyen du leter etter finnes ikke eller er stengt.',
        gameNotStartedTitle: 'Spillet har ikke startet',
        gameNotStartedDescription: 'Spillet har ikke startet ennå.',
        backToLobbies: 'Tilbake til lobbyer',
        backToGames: 'Tilbake til spill',
        ...
        moveFailed: 'Kunne ikke sende trekket.',
        winsLabel: 'seire',
        playerWins: '{{player}} vinner!',
        noMovesLeft: '{{player}} har ingen lovlige trekk igjen',
        timeoutLoss: '{{player}} gikk tom for tid',
        side1: 'Mørk',
        side2: 'Lys',
        noMovesYet: 'Ingen trekk ennå. Mørk begynner.',
        mustCapture: 'Du må slå: velg en uthevet brikke',
        continueJump: 'Fortsett å hoppe med samme brikke',
        selectPiece: 'Trykk på en brikke for å se hvor den kan gå',
        piecesLeft: '{{count}} igjen',
        kingLabel: 'Konge',
        showResults: 'Vis resultat',
    ...
    ludo: {
      name: 'Ludo-spill',
      description: 'Kast terningen, løp brikkene dine rundt brettet og få alle hjem først.',
      difficulty: 'Lett',
      seo: {
      ...
      modes: {
        quick: 'Rask (2 brikker)',
        classic: 'Klassisk (4 brikker)',
        helper: 'I hurtigmodus har alle to brikker, så et spill tar omtrent et kvarter.',
      },
      colors: {
        red: 'Rød',
        green: 'Grønn',
      ...
      lobbies: {
        ...
        createAccount: 'Opprett konto',
        createNewLobby: 'Opprett ny lobby',
        createDescription: 'Start et Ludo-spill og inviter opptil tre venner!',
        createNow: 'Opprett nå',
        quickJoin: 'Hurtiginngang',
        quickJoinDesc: 'Har du en lobbykode? Skriv den inn nedenfor!',
        enterCode: 'Skriv inn 4-sifret kode',
      ...
      game: {
        ...
        backToLobbies: 'Tilbake til lobbyer',
        backToGames: 'Tilbake til spill',
        loadFailed: 'Kunne ikke laste Ludo-spillet.',
        moveFailed: 'Kunne ikke sende trekket ditt.',
        unknownPlayer: 'Ukjent',
        timeoutMoved: 'Tiden gikk ut, så serveren spilte turen din.',
        newGameStarted: 'Nytt spill startet med de samme spillerne.',
        tokenLabel: '{{color}} brikke {{number}}',
        tokensHome: '{{home}}/{{total}} hjemme',
        homeLabel: 'brikker hjemme',
        pickToken: 'Du slo {{value}}: velg en brikke',
        yourRoll: 'Din tur: kast terningen',
        playerTurn: '{{player}} sin tur',
        playerWins: '{{player}} vinner!',
        youWon: 'Alle brikkene dine er hjemme',
        events: {
          enter: 'flyttet brikke {{number}} ut',
          move: 'flyttet brikke {{number}}',
          capture: 'slo ut {{victims}} med brikke {{number}}',
          home: 'fikk brikke {{number}} hjem',
          noMove: 'hadde ikke noe lovlig trekk',
          tripleSix: 'slo tre seksere og mistet turen',
        },
        recentRolls: 'Siste kast av {{player}}',
        serverRollsNote: 'Alle terninger kastes på serveren.',
        rollsTitle: 'Kast',
        noMovesYet: 'Ingen kast ennå.',
        rolledValue: 'Slo {{value}}',
        rulesTitle: 'Slik fungerer Ludo',
        rulesTab: 'Regler',
        showResults: 'Vis resultater',
        lastRollLabel: '{{player}} slo {{value}}',
        noRollYet: 'Ingen har kastet ennå',
        tapHighlighted: 'Trykk på en markert brikke',
        rollHint: 'En sekser flytter en brikke ut og gir nytt kast',
        waitingFor: 'Venter på {{player}}',
        rolling: 'Kaster…',
        boardLabel: 'Ludo-brett',
        roll: 'Kast',
      },
    },
    alias: {
    ...
    guess_my_drawing: {
      ...
      game: {
        ...
        alreadyGuessed: 'Du gjettet det! Venter på de andre',
  ...
  game: {
    ui: {
      ...
      howToPlayRuleCheckers: 'Flytt diagonalt fremover, slå når du kan, og kron en konge på bakerste rad.',
      howToPlayRuleAlias: 'Forklar ordet uten å si det, og la laget gjette.',
      howToPlayRuleLudo: 'Slå en sekser for å komme ut av gården, og få alle brikkene hjem først.',
  ...
  yahtzee: {
    ...
    ui: {
      ...
      tileScoredAria: '{{category}}: ført {{score}}',
      tileOpenAria: '{{category}}: ledig',
      tileScoreAria: '{{category}}: før {{score}}',
      tileConfirmZeroAria: '{{category}}: trykk igjen for å føre 0',
      tapAgainZero: 'Trykk igjen: 0',
      burnBadge: 'Stryk',
      upperShort: 'Øvre',
      lowerShort: 'Nedre',
      ...
      behindPar: '{{count}} bak',
      playersCard: 'Kortet til {{player}}',
      pickArrow: 'Velg {{category}} →',
      burnArrow: 'Stryk {{category}} →',
      backToMine: 'Mitt kort',
      scoresLabel: 'Poeng',
      youPill: 'Du',
      pillAria: '{{player}}: {{score}} poeng, vis kortet',
      dieAria: 'Terning med {{value}}, trykk for å holde',
      dieHeldAria: 'Terning med {{value}}, holdt, trykk for å slippe',
      dieBlankAria: 'Terning, ikke kastet ennå',
      rollWaiting: 'Venter',
      rollWithCount: 'Kast · {{count}}',
      playerTurn: '{{player}} sin tur',
      turnRollFirst: 'Din tur: kast',
      turnHoldOrPick: 'Kast igjen eller velg en rute',
  ...
  auth: {
    ...
    verifyEmail: {
      ...
      signInAgain: 'E-postadressen er endret. Logg inn på nytt med den nye adressen.',
  ...
  profile: {
    ...
    inline: {
      ...
      currentPasswordHint: 'Skriv inn nåværende passord for å bekrefte den nye e-posten.',
      currentPasswordRequired: 'Skriv inn nåværende passord for å endre e-posten.',
      currentPasswordIncorrect: 'Passordet er ikke riktig.',
      recentSignInRequired: 'Av sikkerhetshensyn må du logge ut og inn igjen, og deretter endre e-posten innen 10 minutter.',
  ...
  guest: {
    ...
    forgetMe: 'Glem meg',
    forgetMeConfirm: 'Slette dataene mine?',
    forgetMeHint: 'Sletter gjestenavnet og spillhistorikken din fra Boardly og fra denne enheten',
    forgetMeDone: 'Vi har slettet gjestedataene dine',
    forgetMeActiveGame: 'Forlat spillet du er i først, og prøv igjen',
    forgetMeFailed: 'Vi kunne ikke slette gjestedataene dine. Prøv igjen',
  ...
  privacyPolicy: {
    ...
    breadcrumbHome: 'Hjem',
    intro: 'Denne erklæringen forklarer hvilke personopplysninger Boardly behandler, hvorfor, på hvilket rettslig grunnlag, hvem som mottar dem, hvor lenge vi lagrer dem og hvilke rettigheter du har. «Vi» betyr Boardly-teamet.',
    updated: 'Sist oppdatert: {{date}}',
    controller: {
      title: '1. Hvem som er ansvarlig for opplysningene dine',
      body: 'Behandlingsansvarlig for personopplysningene som beskrives her, er {{name}}, {{address}}, Norge, som driver Boardly.',
      bodyNoIdentity: 'Boardly drives fra Norge av Boardly-teamet.',
      contact: 'Skriv til {{email}} om alt i denne erklæringen, også innsyn, retting, sletting, eksport og innsigelser.',
      dpo: 'Vi har ikke utnevnt et personvernombud: loven krever det ikke for en tjeneste av denne typen.',
    },
    purposes: {
      title: '2. Hva vi behandler, hvorfor og på hvilket rettslig grunnlag',
      lead: 'Grunnlagene følger av personvernforordningen (GDPR), som gjelder i Norge gjennom personopplysningsloven: avtale (art. 6 nr. 1 b) når vi trenger opplysningene for å levere tjenesten du har bedt om, berettiget interesse (art. 6 nr. 1 f) når vi navngir interessen, og samtykke (art. 6 nr. 1 a) når du har valgt å gi det og kan trekke det tilbake når som helst.',
      dataLabel: 'Hva vi behandler',
      basisLabel: 'Rettslig grunnlag',
      ...
      guest: {
        ...
        data: 'Et gjestenavn, en tilfeldig gjeste-id, når du sist var aktiv, og plassene dine i spill. Ingen e-postadresse og intet passord.',
        basis: 'Avtale: vi trenger dette for at du skal kunne spille uten konto.',
        retention: 'En gjest som aldri har spilt, slettes etter {{guestIdle}} dager uten aktivitet, en gjest som har spilt, etter {{guestPlayed}} dager. Navnet erstattes da med «Deleted player» i andre spilleres spillhistorikk og reprise.',
      },
      games: {
      ...
      signIn: {
        ...
        data: 'Konto-id-en din hos tjenesten, navn, e-postadresse og bilde, og nøklene (tokens) tjenesten gir oss. Tjenesten får vite at du logget inn på Boardly.',
        basis: 'Avtale: du valgte denne måten å logge inn på.',
        retention: 'Til du kobler fra tjenesten eller sletter kontoen.',
      },
      email: {
      ...
      marketing: {
        title: 'Nyheter om Boardly på e-post',
        data: 'Bare hvis du krysser av ved registrering eller slår det på i profilinnstillingene: at du sa ja, og når. Vi sender ikke slik e-post ennå.',
        basis: 'Samtykke.',
        retention: 'Til du trekker samtykket tilbake eller sletter kontoen. Du kan trekke det tilbake med innstillingen i profilen, eller med lenken for å melde deg av med ett klikk som hver slik e-post vil ha, gratis og uten å logge inn.',
      },
      push: {
        title: 'Pushvarsler',
        data: 'Bare hvis du slår dem på: pushadressen og nøklene nettleseren din gir oss, og nettlesertypen din. Hvert varsel går gjennom pushtjenesten til den som lager nettleseren din.',
        basis: 'Samtykke: du slår dem på og kan slå dem av.',
        retention: 'Til du slår dem av eller sletter kontoen.',
      },
      premium: {
      ...
      security: {
        ...
        data: 'IP-adressen din og nettleseropplysninger i forespørselsloggene hos driftsleverandøren vår; tellere knyttet til IP-adressen din som begrenser hvor ofte innlogging, å bli med, chat og lignende kan gjentas; feilrapporter (feilen, siden, nettleser og operativsystem) som sendes til Sentry; rapporter fra nettleseren din om innhold sikkerhetsreglene våre blokkerte (regelen, siden, den blokkerte adressen og noen ganger en kort skriptbit), lagret uten kobling til noen konto; tekniske hendelser om hvordan nettstedet går; og en logg over handlinger administratorene våre gjør på kontoer.',
        basis: 'Vår berettigede interesse i å holde Boardly sikkert, tilgjengelig og fritt for misbruk.',
        retention: 'Forespørselslogger: 1 dag. Tellere for hastighetsbegrensning: til tidsvinduet deres er over. Feilrapporter: høyst 90 dager. Tekniske hendelser og rapporter om blokkert innhold: {{eventsDays}} dager. Administratorlogg: {{auditMonths}} måneder.',
      },
      analytics: {
    ...
    recipients: {
      title: '3. Hvem som mottar opplysningene dine',
      lead: 'Vi selger ikke personopplysningene dine. Leverandørene nedenfor behandler dem for oss, unntatt der vi sier at de handler på egne vegne. Vi utleverer opplysninger til myndigheter bare når loven krever det.',
      providerLabel: 'Leverandør',
      purposeLabel: 'Hva vi bruker den til',
      whereLabel: 'Hvor opplysningene er, og grunnlaget for overføring ut av EØS',
      supabase: {
        purpose: 'Database, profilbilder og direkteoppdateringer i spill',
        where: 'Lagret i Zürich i Sveits, som EU anerkjenner som et land med tilstrekkelig beskyttelse. Supabase er et amerikansk selskap og bruker EUs standard personvernbestemmelser.',
      },
      vercel: {
      ...
      upstash: {
        ...
        where: 'Lagret i Frankfurt i Tyskland. Upstash er et amerikansk selskap og bruker EU–US Data Privacy Framework eller EUs standard personvernbestemmelser ved en eventuell overføring.',
      },
      resend: {
        purpose: 'Sende e-posten vår og ta imot e-post til kundestøtteadressen',
      ...
      discord: {
        ...
        where: 'USA. Discord er sertifisert under EU–US Data Privacy Framework og bruker EUs standard personvernbestemmelser.',
      },
      google: {
        purpose: 'Innlogging med Google, og AdSense-skriptet med samtykkemeldingen (på egne vegne)',
        where: 'USA. Google er sertifisert under EU–US Data Privacy Framework og bruker også EUs standard personvernbestemmelser.',
      },
      github: {
        purpose: 'Innlogging med GitHub (på egne vegne)',
        where: 'USA. GitHub bruker EUs standard personvernbestemmelser og er også sertifisert under EU–US Data Privacy Framework.',
      },
      pushService: {
        name: 'Pushtjenesten til nettleseren din',
        purpose: 'Levere pushvarslene du har slått på',
        where: 'Valgt av den som lager nettleseren din (for eksempel Google, Mozilla eller Apple), ikke av oss.',
      },
      note: 'EU-kommisjonen har anerkjent at amerikanske selskaper som deltar i EU–US Data Privacy Framework, gir tilstrekkelig beskyttelse. EUs standard personvernbestemmelser er avtalevilkår som kommisjonen har godkjent.',
    },
    discord: {
      title: '4. Discord-integrasjon',
      ...
      linkedRoles: 'Linked Roles: hvis du kobler Discord til Boardly med tillatelse til å oppdatere tilkoblingen din, sender vi Discord brukernavnet ditt på Boardly og fire verdier – om du har Premium, hvor mange spill du har spilt, når du ble med og om e-postadressen din er bekreftet – når du kobler til, når Premium endres, og én gang i natten. Servere som bruker dem, kan gi deg roller. Når du kobler fra Discord eller sletter kontoen, fjerner vi dem. Det rettslige grunnlaget er samtykket ditt; å koble fra trekker det tilbake.',
    },
    ads: {
      title: '5. Annonser',
    ...
    storage: {
      title: '6. Informasjonskapsler og lagring på enheten din',
      lead: 'Vi lagrer bare det nettstedet trenger for å fungere, i tillegg til punktene her:',
    ...
    complaints: {
      title: '8. Klage',
      body: 'Du har rett til å klage til Datatilsynet, eller til tilsynsmyndigheten der du bor eller arbeider. Vi setter pris på å få sjansen til å rette opp i det først: skriv til {{email}}.',
    },
    security: {
      title: '9. Sikkerhet',
      body: 'Passord lagres bare som bcrypt-hasher, all trafikk bruker HTTPS, og bare tjenestene som trenger det, når databasen. En tilbakestilling av passord logger ut alle andre økter, og en fullført endring av e-post logger ut alle.',
    },
    children: {
      title: '10. Barn',
    ...
    changes: {
      ...
      body: 'Når vi endrer denne erklæringen, oppdaterer vi datoen nedenfor. Vi sier fra om vesentlige endringer på e-post eller med en melding på nettstedet.',
    },
  },
  premium: {
    breadcrumb: 'Premium',
    ...
    withdrawalTitle: 'Din angrerett',
    withdrawalBody: 'Du har 14 dagers angrerett fra den dagen du kjøper Premium, uten å oppgi noen grunn. Angrer du, betaler vi tilbake alt du har betalt for kjøpet innen 14 dager etter at vi fikk beskjeden, med samme betalingsmåte og uten gebyr.',
  ...
  withdrawal: {
    breadcrumb: 'Angrerett',
    title: 'Angrerett for Boardly Premium',
    intro: 'Når du kjøper Boardly Premium på boardly.online, har du angrerett etter angrerettloven. Du kan gå fra avtalen innen 14 dager fra den dagen du kjøpte, uten å oppgi noen grunn.',
    refund: 'Angrer du innen fristen, betaler vi tilbake alt du har betalt for kjøpet, senest 14 dager etter at vi fikk beskjeden. Pengene går tilbake med samme betalingsmåte som du brukte, uten gebyr.',
    ...
    howFormLabel: 'Med skjemaet nedenfor',
    howFormBody: 'Kopier teksten, fyll inn feltene og send den til oss på e-post. Oppgi e-postadressen til Boardly-kontoen din, så finner vi kjøpet. Sender du skjemaet på papir, skriver du det ut og signerer.',
    afterTitle: 'Hva som skjer etterpå',
    after1: 'Vi bekrefter på e-post at vi har mottatt meldingen din.',
    after2: 'Vi betaler tilbake hele beløpet innen 14 dager, og abonnementet avsluttes. Ingenting mer blir trukket.',
    after3: 'Link sender deg varselet om refusjonen på e-post. Det tar vanligvis 3 til 7 virkedager før pengene er tilbake på kortet eller kontoen din.',
    linkTitle: 'Du kan også spørre Link',
    linkBody: 'Du kan også be Links kundestøtte om refusjonen. Links vilkår gir forbrukere i EU og Storbritannia 14 dagers angrefrist: kontakt Links kundestøtte, følg stegene for å be om refusjon og oppgi «cooling off period» som grunn. Kan ikke Link hjelpe deg, skriver du til oss, og full refusjon innen 14 dager slik denne siden beskriver, gjelder fortsatt.',
    linkSupportLabel: 'Links kundestøtte for kjøp merket «Sold through Link»',
    formTitle: 'Angreskjema',
    formHint: 'Fyll ut og returner dette skjemaet dersom du ønsker å gå fra avtalen.',
    formToLabel: 'Utfylt skjema sendes til',
    formStatement: 'Jeg underretter herved om at jeg ønsker å gå fra min avtale om kjøp av følgende tjeneste: Boardly Premium (abonnement).',
    formOrdered: 'Avtalen ble inngått den (dato)',
    formName: 'Forbrukerens navn',
    formAddress: 'Forbrukerens adresse',
    formDate: 'Dato',
    formSignature: 'Forbrukerens underskrift (dersom papirskjema benyttes)',
    formSource: 'Skjemaet følger det norske standardskjemaet Q-0319B, som gjennomfører vedlegg I B til direktiv 2011/83/EU.',
    copyButton: 'Kopier e-posttekst',
    copied: 'Kopiert. Lim teksten inn i en e-post til {{email}}.',
    copyFailed: 'Kopiering er ikke tilgjengelig i denne nettleseren. Merk teksten over og kopier den selv.',
    emailButton: 'Åpne i e-postprogrammet',
    emailSubject: 'Angrerett: Boardly Premium',
    backToPremium: 'Tilbake til Premium',
  },
  terms: {
    premium: {
      ...
      confirmation: 'Etter hvert kjøp sender vi deg en bekreftelse på e-post som gjentar disse opplysningene; ta vare på den. Kvitteringen og fakturaen kommer fra Link i en egen e-post.',
      minors: 'Premium kan kjøpes av voksne, eller fra fylte 15 år med penger du selv har rett til å bruke. Et kjøp gjort av en mindreårig uten slik rett betales tilbake når vergen ber om det.',
    },
  },
  onboarding: {
