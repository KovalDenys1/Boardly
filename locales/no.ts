const no = {
  ...
  premium: {
    ...
    priceNoteTax: 'Prisen som vises, er full pris; det legges ikke til merverdiavgift.',
  ...
  withdrawal: {
    ...
    later: 'Du kan si opp når som helst i faktureringsportalen på profilsiden din. En månedsplan løper ut måneden du har betalt for. Sier du opp en årsplan før tiden, betaler vi tilbake de ubrukte hele månedene.',
