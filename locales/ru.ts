const ru = {
  ...
  tour: {
    ...
    steps: {
      welcome: {
        title: 'Добро пожаловать в Boardly!',
        description: 'Давай быстро покажем тебе платформу и всё, что можно делать.',
      },
      games: {
        title: 'Каталог игр',
        description: 'Здесь все доступные настольные игры. Нажми на карточку, чтобы создать лобби.',
      },
      createLobby: {
        title: 'Создать лобби',
        description: 'Открой свою игровую комнату, выбери игру, установи пароль и пригласи друзей.',
      },
      findLobbies: {
        title: 'Найти лобби',
        description: 'Ищи и фильтруй существующие лобби по типу игры, статусу или коду.',
      },
      profile: {
        title: 'Твой профиль',
        description: 'Статистика, история игр и список друзей — всё в одном месте.',
      },
      quickStart: {
        title: 'Ты готов играть!',
        description: 'Выбери игру ниже, и мы мгновенно создадим лобби с ботом.',
      },
    },
  },
} as const
