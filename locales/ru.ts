const ru = {
  ...
  profile: {
    ...
    comingSoon: 'Скоро',
    inline: {
      headerHint: 'Дважды нажмите на имя или почту, чтобы изменить их, или используйте кнопку редактирования на телефоне',
      ...
      changeEmailHint: 'Дважды нажмите на почту выше, чтобы изменить её',
