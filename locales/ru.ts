const ru = {
  ...
  faq: {
    ...
    q4: {
      question: 'Можно ли играть против ботов?',
      answer: 'Да. Яхтзи и Крестики-нолики поддерживают AI-соперников — можно играть соло или заполнять пустые места.',
    },
    q5: {
      question: 'Как играть с друзьями онлайн?',
      answer: 'Создай лобби и поделись кодом комнаты или ссылкой. Друзья присоединяются мгновенно — без аккаунта и скачиваний.',
    },
    q6: {
      question: 'Работает ли Boardly на мобильном?',
      answer: 'Да. Boardly работает в любом современном браузере на компьютере, планшете и смартфоне. Также есть PWA — можно установить как приложение.',
    },
    q7: {
      question: 'Сколько игроков могут играть одновременно?',
      answer: 'Зависит от игры. Крестики-нолики — 2 игрока, Яхтзи и Память — до 4, Угадай шпиона — до 10 игроков в одном лобби.',
    },
    q8: {
  ...
  onboarding: {
    ...
    subtitle: 'Сыграй против бота прямо сейчас',
    chooseGame: 'Выбери игру',
    startPlaying: 'Начать играть →',
    starting: 'Запускаем...',
    skip: 'Пропустить',
    takeTour: 'Показать мне всё',
    takeTourSubtitle: 'Быстрый тур по платформе',
    quickStart: 'Сразу в игру',
    quickStartSubtitle: 'Сыграть против бота прямо сейчас',
  },
  tour: {
    steps: {
      welcome: {
        title: 'Добро пожаловать в Boardly!',
        description: 'Boardly — платформа для многопользовательских настольных игр в реальном времени. Давай быстро покажу, что здесь можно делать.',
      },
      games_grid: {
        title: 'Список игр',
        description: 'Это твоя библиотека игр. Выбирай из доступных — каждая работает в режиме реального времени с другими игроками.',
      },
      create_lobby: {
        title: 'Создать лобби',
        description: 'Нажми сюда, чтобы создать новую игровую комнату. Выбери игру, настрой правила и поделись кодом с друзьями.',
      },
      lobby_filters: {
        title: 'Найти игры',
        description: 'Используй фильтры, чтобы найти открытые лобби по типу игры, статусу или количеству игроков.',
      },
      profile_stats: {
        title: 'Твоя статистика',
        description: 'В профиле хранится статистика побед, сыгранных партий и многое другое по всем играм.',
      },
    },
    navigation: {
      next: 'Далее →',
