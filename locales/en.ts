  ...
  games: {
    ...
    guess_my_drawing: {
      ...
      detail: {
        ...
        step2Desc: 'On your turn you get a secret word and up to 90 seconds to draw it.',
        step3Title: 'Guess before the clock runs out',
        step3Desc: 'Everyone else types guesses for up to a minute. The first correct one scores the most.',
