const en = {
  ...
  yahtzee: {
    ...
    ui: {
      ...
      tileScoredAria: '{{category}}: scored {{score}}',
      tileOpenAria: '{{category}}: open',
      tileScoreAria: '{{category}}: score {{score}}',
      tileConfirmZeroAria: '{{category}}: tap again to score 0',
      tapAgainZero: 'Tap again for 0',
      burnBadge: 'Burn',
      upperShort: 'Upper',
      lowerShort: 'Lower',
      ...
      behindPar: '{{count}} behind',
      playersCard: '{{player}}\'s card',
      pickArrow: 'Pick {{category}} →',
      burnArrow: 'Burn {{category}} →',
      backToMine: 'My card',
      scoresLabel: 'Scores',
      youPill: 'You',
      pillAria: '{{player}}: {{score}} points, show card',
      dieAria: 'Die showing {{value}}, tap to hold',
      dieHeldAria: 'Die showing {{value}}, held, tap to release',
      dieBlankAria: 'Die, not rolled yet',
      rollWaiting: 'Waiting',
      rollWithCount: 'Roll · {{count}}',
      playerTurn: '{{player}}\'s turn',
      turnRollFirst: 'Your turn: roll',
      turnHoldOrPick: 'Roll again or pick a box',
  ...
  privacyPolicy: {
    ...
    purposes: {
      ...
      premium: {
        title: 'Premium',
        data: 'Premium is sold through Link: Stripe\'s affiliate Sold through Link, LLC (USA) is the merchant of record and takes the payment. To calculate VAT or sales tax, Link collects your name, billing address and any tax ID at checkout, and it shares the order information with us: your contact details, billing address, payment information, tax ID and the order details. It also updates the name and billing address on your customer record in our Stripe account. We never receive your full card number. We keep your Stripe customer and subscription ids, your Premium status and dates, and a record of what you agreed to at checkout: the plan, the versions of the terms and the withdrawal information you were shown, and when you agreed.',
        basis: 'Contract. The checkout record: also our legitimate interest in being able to show what you agreed to.',
        retention: 'Until you delete the account. We then cancel any subscription and delete your customer record at Stripe. Stripe and Link keep their own payment and order records as their privacy policies describe. Deleting your Link account cancels a subscription sold through Link and deletes the information you gave for that order.',
      },
      feedback: {
    ...
    recipients: {
      ...
      stripe: {
        purpose: 'Premium payments. Stripe keeps our customer and subscription records for us. Its affiliate Sold through Link, LLC is the merchant of record for Premium and acts on its own account, as an independent controller under Link\'s terms and privacy policy.',
        where: 'Stripe: Stripe Payments Europe in Ireland, with transfers to Stripe in the USA under the EU-US Data Privacy Framework and Standard Contractual Clauses. Sold through Link, LLC: in the USA, so your order data is transferred there; Link\'s privacy policy names the EU-US Data Privacy Framework, which Stripe complies with, and Standard Contractual Clauses as its safeguards.',
      },
      sentry: {
  ...
  premium: {
    ...
    save: 'Save {{percent}}%',
    currencyNote: 'Listed in the currency the plan is priced in. Link converts it to your own currency at checkout, so the amount on the payment page is the one you pay.',
    ...
    faq: {
      ...
      q3: {
        ...
        answer: 'The plan has one list price, and Link converts it to your local currency during checkout. The payment page shows the exact amount before you confirm.',
      },
      q4: {
        question: 'Can I switch between monthly and yearly?',
        answer: 'Yes. Open the billing portal from your profile page and change the plan there; Link handles the difference for the time already paid.',
      },
      q5: {
        question: 'Do you take promo codes?',
        answer: 'Yes. There is a promo code field on the payment page, so a code can be applied right before you pay.',
      },
    },
  ...
  withdrawal: {
    ...
    soldThroughLink: 'Premium is sold through Link: Stripe\'s affiliate Sold through Link, LLC is the merchant of record for the purchase. Link takes the payment and emails your receipt, your invoice and any refund notice. You withdraw with us as described below, and we make the refund through Link.',
    laterTitle: 'After the 14 days',
    later: 'You can cancel at any time from the billing portal on your profile page. A monthly plan then runs to the end of the month you paid for. If you cancel a yearly plan early, we refund the unused whole months. Cancelling in your Link account at link.com, or deleting that account, follows Link\'s terms instead.',
    ...
    after3: 'Link emails you the refund notice. A refund generally takes 3 to 7 business days to reach your card or bank account.',
    linkTitle: 'Asking Link instead',
    linkBody: 'You can also ask Link support for the refund. Link\'s terms give consumers in the EU and the UK a 14-day cooling-off period: contact Link support, follow the steps for requesting a refund and give "cooling off period" as the reason. If Link cannot help, write to us, and the full refund within 14 days described on this page still applies.',
    linkSupportLabel: 'Link support for "Sold through Link" purchases',
  ...
  terms: {
    premium: {
      ...
      withdrawal: 'At checkout you ask us to start Premium immediately. You still have the right to withdraw from the purchase within 14 days, without giving a reason. We refund everything you paid for that purchase within 14 days of receiving your notice, by the same payment method and without a fee. The refund goes through Link, which emails you the refund notice.',
      withdrawalHow: 'To withdraw, send us an email or use the form on our withdrawal page:',
      linkChannel: 'You can also ask Link support for the refund. Link\'s terms give consumers in the EU and the UK a 14-day cooling-off period, which you use by contacting Link support and giving "cooling off period" as the reason for the refund request. Link also helps with payment problems, such as a charge you do not recognise. If Link cannot help, write to us, and our full refund within 14 days still applies.',
      confirmation: 'After each purchase we email you a confirmation that repeats this information; please keep it. Your receipt and invoice come from Link in a separate email.',
      minors: 'Premium can be bought by adults, or from the age of 15 with money you are entitled to spend yourself. A purchase made by a minor without that right is refunded at the guardian\'s request.',
    },
  },
  onboarding: {
