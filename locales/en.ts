const en = {
  ...
  withdrawal: {
    ...
    later: 'You can cancel at any time from the billing portal on your profile page or in your Link account at link.com. A monthly plan runs to the end of the month you paid for. If you cancel a yearly plan early, we refund the unused whole months.',
  ...
  terms: {
    premium: {
      ...
      renewal: 'The subscription renews automatically at the end of each paid period, at the same US dollar price, until you cancel. If you pay in your own currency, each renewal is converted at the rate of the day it is charged, so the amount in your currency can vary. You can cancel at any time from your profile or in your Link account at link.com; access continues to the end of the period you have paid for. If you cancel a yearly plan early, we refund the unused whole months.',
